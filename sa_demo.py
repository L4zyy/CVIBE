...
from lib.models.vibe import SA_VIBE_Demo
...
def main(args):
    ...
    # pretrained_file = 'results/vibe_tests/19-11-2020_11-23-41_vibe/model_best.pth.tar'
    pretrained_file = 'sa_model_best.pth.tar'
    ckpt = torch.load(pretrained_file)
    print(f'Performance of pretrained model on 3DPW: {ckpt["performance"]}')
    ckpt = ckpt['gen_state_dict']
    model.load_state_dict(ckpt, strict=False)
